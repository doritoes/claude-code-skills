...
| AWS GPU | 6 | g4dn.xlarge | ~5m | 2160 (43.2%) | 432/min | ~150 GH/s |
...
2. **6x GPU = 1x GPU for wordlist attacks** - No speedup because crackable passwords are at start of wordlist
3. **XCP-ng fastest CPU** (5h 58m) - local hypervisor with dedicated resources
4. **OCI 2nd fastest** (7h 21m) - 2x vCPU (32 vs 16) yielded +55% speed, not 2x
5. **Azure slowest cloud** (9h 41m) - consistent with pricing being higher
6. **Identical crack rate** (43.2%) across all providers - wordlist coverage is consistent
