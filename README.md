...
|-------|-------------|---------|--------|
| [MSV](skills/MSV/) | Minimum Safe Version calculator + CTI Report Generator — 205-product catalog, 6 data sources (CISA KEV, AppThreat, NVD, VulnCheck, EPSS, vendor advisories), Admiralty Code confidence ratings | v1.5.0 | Stable |
